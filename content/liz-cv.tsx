...
export const CV = {
  ...
  eduction: [
    /* {
      ...
      city: "Manila",
      country: "Philippines ",
      institution: "Adventist University of the Philippines Academy Silang Cavite",
      certificate: "High School Diploma, National Senior Certificate (NQF level 4)",
      level: "School",
      type: ["relevant"],
    },*/
    {
  ...
  experience: [
    {
      ...
      responsibilities: [
        ...
        /* {
          content:
            "Monitoring competitors' social media activities and making recommendations for improvement.",
          type: ["relevant"],
        },*/
        {
        ...
        /* {
          content:
            "Continuously monitoring and optimizing the e-commerce store's user experience based on customer feedback, analytics, and best practices.",
          type: ["relevant"],
        },*/
      ],
    },
    ...
    /*    {
      ...
      responsibilities: [
        ...
        {
          content: "Brand management at Stellenbosch Wine-festival ",
          type: ["relevant"],
        },
        {
        ...
        {
          content: "Project management for Knysna Oyster Festival & Knysna Forest Marathon",
          type: ["relevant"],
        },
      ],
    },
  ...
  certifications: [
    ...
    /* {
      date: "2017",
      name: "200hr Yoga Teacher Training - RYT Qualification",
      type: ["relevant"],
    },*/
    {
      date: "2015",
