...
const contactData = {
  ...
  email: "felix@tellmann.dev",
  website: "tellmann.dev"
};

const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/felixtellmann",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://linkedin.com/in/felixtellmann",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Twitter",
    url: "https://twitter.com/felixtellmann",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
const FloatingShape: FC<{ shape: typeof backgroundShapes[0]; index: number }> = ({ shape, index }) => {
...
export const Contact: FC = () => {
  ...
  useEffect(() => {
    ...
    const typeWriter = (element: HTMLElement, text: string, delay: number = 0, speed: number = 150) => {
    ...
    const animateDesktopNotifications = () => {
      ...
      const directions = ['top-left', 'top-right', 'bottom-left', 'bottom-right', 'left-side', 'right-side'];
  ...
  const handleEmailHover = (isHovering: boolean) => {
    ...
    if (avatar && blushLeft && blushRight && happyEyesLeft && happyEyesRight && normalSmile && happySmile) {
      if (isHovering) {
  ...
  return (
    ...
    >
          ...
          <div className="notification-content">
            <div className="notification-avatar">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                ...
                <path d="M20 8C13.4 8 8 13.4 8 20C8 26.6 13.4 32 20 32C26.6 32 32 26.6 32 20C32 13.4 26.6 8 20 8ZM25.2 17.2L18.8 23.6C18.4 24 17.8 24 17.4 23.6L14.8 21C14.4 20.6 14.4 20 14.8 19.6C15.2 19.2 15.8 19.2 16.2 19.6L18.1 21.5L23.8 15.8C24.2 15.4 24.8 15.4 25.2 15.8C25.6 16.2 25.6 16.8 25.2 17.2Z" fill="white"/>
              </svg>
            </div>
            <div className="notification-text">
              <div className="notification-username">@portfolio_bot</div>
              <div className="notification-message">Thank you for scrolling till the bottom! 🎉</div>
          ...
          <div className="notification-content">
            <div className="notification-avatar">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                ...
                <path d="M20 12C16.7 12 14 14.7 14 18V22C14 25.3 16.7 28 20 28C23.3 28 26 25.3 26 22V18C26 14.7 23.3 12 20 12ZM22 18V22C22 23.1 21.1 24 20 24C18.9 24 18 23.1 18 22V18C18 16.9 18.9 16 20 16C21.1 16 22 16.9 22 18Z" fill="white"/>
              </svg>
            </div>
            <div className="notification-text">
              <div className="notification-username">@dev_insights</div>
              <div className="notification-message">Hope you found this portfolio interesting 💻</div>
          ...
          <div className="notification-content">
            <div className="notification-avatar">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                ...
                <path d="M20 8C13.4 8 8 13.4 8 20C8 26.6 13.4 32 20 32C26.6 32 32 26.6 32 20C32 13.4 26.6 8 20 8ZM24 21H21V24C21 24.6 20.6 25 20 25C19.4 25 19 24.6 19 24V21H16C15.4 21 15 20.6 15 20C15 19.4 15.4 19 16 19H19V16C19 15.4 19.4 15 20 15C20.6 15 21 15.4 21 16V19H24C24.6 19 25 19.4 25 20C25 20.6 24.6 21 24 21Z" fill="white"/>
              </svg>
            </div>
            <div className="notification-text">
          ...
          <div className="notification-content">
            <div className="notification-avatar">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                ...
                <path d="M12 14H28C28.6 14 29 14.4 29 15V25C29 25.6 28.6 26 28 26H12C11.4 26 11 25.6 11 25V15C11 14.4 11.4 14 12 14ZM13 16V24H27V16H13ZM15 18H17V20H15V18ZM19 18H21V20H19V18ZM23 18H25V20H23V18Z" fill="white"/>
              </svg>
            </div>
            <div className="notification-text">
      ...
      <div className="contact-card">
        ...
        <div className="card-content">
          ...
          <div className="info-section">
            ...
            <circle className="blush-left" cx="65" cy="115" r="12" fill="url(#blushGradient)" opacity="0" style={{transition: 'opacity 0.3s ease'}} />
            <circle className="blush-right" cx="135" cy="115" r="12" fill="url(#blushGradient)" opacity="0" style={{transition: 'opacity 0.3s ease'}} />
            
            {/* Hair */}
            <path d="M 45 60 Q 50 30, 80 25 T 120 28 T 150 35 Q 155 50, 150 65 Q 145 55, 135 50 T 110 48 T 85 50 Q 65 55, 55 65 Q 50 55, 45 60" fill="#1a1a1a" />
            ...
            {/* Additional curls */}
            <path d="M 55 50 Q 60 45, 65 48 T 70 55" fill="none" stroke="#1a1a1a" strokeWidth="4" strokeLinecap="round" />
            <path d="M 130 45 Q 135 40, 140 43 T 145 50" fill="none" stroke="#1a1a1a" strokeWidth="4" strokeLinecap="round" />
            
            {/* Glasses */}
            <g id="glasses">
              {/* Left lens */}
              <rect x="55" y="80" width="35" height="30" rx="5" fill="none" stroke="#2a2a2a" strokeWidth="3" />
              <rect x="57" y="82" width="31" height="26" rx="4" fill="rgba(255,255,255,0.1)" />
              
              {/* Right lens */}
              <rect x="110" y="80" width="35" height="30" rx="5" fill="none" stroke="#2a2a2a" strokeWidth="3" />
            ...
            <path className="happy-eyes-left" d="M 65 90 Q 72 85, 79 90" fill="none" stroke="#1a1a1a" strokeWidth="3" strokeLinecap="round" opacity="0" style={{transition: 'opacity 0.3s ease'}} />
            <path className="happy-eyes-right" d="M 121 90 Q 128 85, 135 90" fill="none" stroke="#1a1a1a" strokeWidth="3" strokeLinecap="round" opacity="0" style={{transition: 'opacity 0.3s ease'}} />
            
            {/* Eyebrows */}
            <path d="M 60 75 Q 72 70, 84 75" fill="none" stroke="#1a1a1a" strokeWidth="3" strokeLinecap="round" />
            <path d="M 116 75 Q 128 70, 140 75" fill="none" stroke="#1a1a1a" strokeWidth="3" strokeLinecap="round" />
            
            {/* Nose */}
            <path d="M 100 100 L 95 115 Q 100 118, 105 115 L 100 100" fill="#c4936d" />
            
            {/* Normal smile */}
            <path className="normal-smile" d="M 75 125 Q 100 140, 125 125" fill="none" stroke="#8b5a3c" strokeWidth="2.5" strokeLinecap="round" style={{transition: 'opacity 0.3s ease'}} />
            
            {/* Happy smile (hidden by default) */}
            <path className="happy-smile" d="M 70 125 Q 100 150, 130 125 Q 100 145, 70 125" fill="#8b5a3c" opacity="0" style={{transition: 'opacity 0.3s ease'}} />
          </svg>
            </div>
            ...
            <div className="contact-data">
              ...
              <div className="data-row">
                ...
                <span className="data-value typewriter" data-text="@felixtellmann"></span>
              </div>
              <div className="data-row">
      ...
      <div className="tech-element">
        ...
        <span className="terminal-command">curl -O tellmann.dev/contact.vcf</span>
      </div>
